function SWOOSHRegfun = ozoneRegression_SWOOSHregfun(timeperiod)
       ...
       MEI = importdata('/Volumes/ExternalOne/work/data/SWOOSH/SWOOSHregfunctions/MEI.dat');
    ...
    syears = [1984:2017]; 
    singapore10 = importdata('/Volumes/ExternalOne/work/data/SWOOSH/SWOOSHregfunctions/qbo10.dat');
    singapore10 = reshape(singapore10,[12,length(singapore10)./12])';    
    singapore30 = importdata('/Volumes/ExternalOne/work/data/SWOOSH/SWOOSHregfunctions/qbo30.dat');
    ...
    solar = importdata('/Volumes/ExternalOne/work/data/SWOOSH/SWOOSHregfunctions/solarcycle.dat');
    solar_dateindex = solar.data(:,1) >= timeperiod(1) & solar.data(:,1) <= timeperiod(2);
    SWOOSHRegfun.solardata = solar.data(solar_dateindex,4);
    
    %% Read in Aerosol
    aerosol = ncread('/Volumes/ExternalOne/work/data/SWOOSH/SWOOSHregfunctions/tau_map_2012-12.nc','tau');
    %[~,aerosol,~] = Read_in_netcdf('/Volumes/ExternalOne/work/data/SWOOSH/SWOOSHregfunctions/tau_map_2012-12.nc');

...
if inputs.plotind
    ...
    for i = 1:size(correlations.individual)
        if ~exist(['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/correlations/maps/Ind_',titlessave{i},'_',monthnames(inputs.varmonthtomean,1,1),'.png'])
            ...
            filename = ['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/correlations/maps/Ind_',titlessave{i},'_',monthnames(inputs.varmonthtomean,1,1)];
        ...
        if ~exist(['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/correlations/maps/Ind_pct_',titlessave2{i},'_',monthnames(inputs.varmonthtomean,1,1),'.png'])
            subplotmaps(correlations.individual_pct(i,:,:),lons,lats,{'div','RdBu'},1,[],16,titles2(i),'Longitude','Latitude','Correlation','on',...
                clims,22,[lons(1:24:end)]-180,[lons(1:24:end)]-180,[0:15:90],[0:15:90],mtitle,1,[0 360],ylim,0,'none',1,'Miller Cylindrical');
            filename = ['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/correlations/maps/Ind_pct_',titlessave2{i},'_',monthnames(inputs.varmonthtomean,1,1)];
            export_fig(filename,'-png');
    ...
    for i = 1:size(correlations.individual)
        if ~exist(['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/differences/maps/Ind_',titlessave{i},'_',monthnames(inputs.varmonthtomean,1,1),'.png'])
            subplotmaps(differences.individual(i,:,:),lons,lats,{'div','RdBu'},1,[],16,titles(i),'Longitude','Latitude','Temperature difference','on',...
                clims,22,[lons(1:24:end)]-180,[lons(1:24:end)]-180,[0:15:90],[0:15:90],mtitle,1,[0 360],ylim,0,'none',1,'Miller Cylindrical');
            filename = ['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/differences/maps/Ind_',titlessave{i},'_',monthnames(inputs.varmonthtomean,1,1)];
            export_fig(filename,'-png');
        end
...
if inputs.plotindmonths
    ...
    for j = 1:size(correlations.indmonths.individual,2)
        ...
        for i = 1:size(correlations.indmonths.individual,1)
            ...
            toplot = toplot(j,:,:);
            if ~exist(['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/correlations/maps/Ind_months','_',titlesindmonthssave{j,i},'.png'],'file')            
                subplotmaps(toplot,lons,lats,{'div','RdBu'},1,[],16,titlesindmonths(j,i),'Longitude','Latitude','Correlation','on',...
                    clims,22,[lons(1:24:end)]-180,[lons(1:24:end)]-180,[0:15:90],[0:15:90],mtitle,1,[0 360],ylim,0,'none',1,'Miller Cylindrical');
                filename = ['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/correlations/maps/Ind_months','_',titlesindmonthssave{j,i}];
                export_fig(filename,'-png');
            end            
        end
    end       
    ...
    for j = 1:size(differences.indmonths.individual,4)
        ...
        for i = 1:size(differences.indmonths.individual,1)
            ...
            %toplot = toplot(j,:,:);
            if ~exist(['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/differences/maps/Ind_months','_',titlesindmonthssave{j,i},'.png'],'file')            
                subplotmaps(toplot,lons,lats,{'div','RdBu'},1,[],16,titlesindmonths(j,i),'Longitude','Latitude','Correlation','on',...
                    clims,22,[lons(1:24:end)]-180,[lons(1:24:end)]-180,[0:15:90],[0:15:90],mtitle,1,[0 360],ylim,0,'none',1,'Miller Cylindrical');                
                filename = ['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/differences/maps/Ind_months','_',titlesindmonthssave{j,i}];
                export_fig(filename,'-png');
            end
        end
    end       
...
if inputs.plotcorr
    ...
    [fig,sh] = subplotmaps(toplot(2,:,:),lons,lats,{'seq','Blues'},0,toplotp(2,:,:),16,titles,'Longitude','Latitude','','on',...
        [0 5],11,[lons(1:24:end)]-180,[lons(1:24:end)]-180,[0:15:90],[0:15:90],mtitle,1,[0 360],ylim,0,'none',1,'Miller Cylindrical');
%     ax = gca;
%     hold on
%     lontoplot = lons-180;
%     pos = get(sh,'position');
...
%     set(ch,'orientation','horizontal','position',[.105 .3 .725 .02],'fontsize',22);
    ...
    filename = ['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/correlations/maps/EnsMean_sigtonoise_stddivmean2_withuwindat500hPa_std',monthnames(inputs.varmonthtomean,1,1),'_',num2str(inputs.timeperiodvar(1)),'-',num2str(inputs.timeperiodvar(2))];
    %export_fig(filename,'-png');
    ...
    subplotmaps(toplot(3,:,:),lons,lats,{'div','RdBu'},1,toplotp(2,:,:),16,titles,'Longitude','Latitude','','on',...
        [-.3 .3],12,[lons(1:24:end)]-180,[lons(1:24:end)]-180,[0:15:90],[0:15:90],mtitle,1,[0 360],ylim,0,'none',1,'Miller Cylindrical');
    
    filename = ['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/correlations/maps/EnsMean_sigtonoise_meanminstd2_',monthnames(inputs.varmonthtomean,1,1),'_',num2str(inputs.timeperiodvar(1)),'-',num2str(inputs.timeperiodvar(2)),ensoext];
    export_fig(filename,'-png');
    ...
    filename = ['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/correlations/maps/EnsMean_correlations2_pct_',monthnames(inputs.varmonthtomean,1,1),'_',num2str(inputs.timeperiodvar(1)),'-',num2str(inputs.timeperiodvar(2)),ensoext];
    export_fig(filename,'-png');        
    ...
    filename = ['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/correlations/maps/EnsMean_sigtonoise_stddivmean2_pct',monthnames(inputs.varmonthtomean,1,1),'_',num2str(inputs.timeperiodvar(1)),'-',num2str(inputs.timeperiodvar(2)),ensoext];
    export_fig(filename,'-png');
    ...
    filename = ['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/correlations/maps/EnsMean_sigtonoise_meanminstd2_pct',monthnames(inputs.varmonthtomean,1,1),'_',num2str(inputs.timeperiodvar(1)),'-',num2str(inputs.timeperiodvar(2)),ensoext];
    export_fig(filename,'-png');
...
if inputs.plotdiff
    ...
    filename = ['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/differences/maps/Composite_sigtonoise_meanminstd_',monthnames(inputs.varmonthtomean,1,1),'_',num2str(inputs.timeperiodvar(1)),'-',num2str(inputs.timeperiodvar(2)),ensoext];
        export_fig(filename,'-png');
    ...
    filename = ['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/differences/maps/EnsMean_Eachyear_sigtonoise_meanminstd_',monthnames(inputs.varmonthtomean,1,1),'_',num2str(inputs.timeperiodvar(1)),'-',num2str(inputs.timeperiodvar(2)),ensoext];
        export_fig(filename,'-png');
    ...
    filename = ['/Users/kanestone/Dropbox (MIT)/Work_Share/MITWork/predruns/differences/maps/EnsMean_sigtonoise_meanminstd_',monthnames(inputs.varmonthtomean,1,1),'_',num2str(inputs.timeperiodvar(1)),'-',num2str(inputs.timeperiodvar(2)),ensoext];
        export_fig(filename,'-png');    
